...
int main(int argc, char **argv) {
    // Set position of the lipid holder interface with the sc motors using counts (6400 counts / revolution)
    // Input: Desired position in counts (X, Z) and velocity to move in rpm
    // Output: Motor hub name and echos desired position in counts
